public class TASubtract extends TABinaryTerm
{
	TAObject operand1;
	TAObject operand2;
	public void list()
	...
	public TASubtract(TAUnaryTerm op1,TAInt op2)
	{
		operand1 = op1;
		operand2 = op2;
	...
	public TASubtract(TAUnaryTerm op1,TADouble op2)
	{
		operand1 = op1;
		operand2 = op2;
	...
	public TASubtract(TAUnaryTerm op1,TAUnaryTerm op2)
	{
		operand1 = op1;
		operand2 = op2;
	...
	public TASubtract(TABinaryTerm op1, TAInt op2)
	{
		operand1 = op1;
		operand2 = op2;
		if(op1.result instanceof TAInt)
	...
	public TASubtract(TABinaryTerm op1,TADouble op2)
	{
		operand1 = op1;
		operand2 = op2;
		if(op1.result instanceof TADouble)
	...
	public TASubtract(TABinaryTerm op1,TABinaryTerm op2)
	{
		operand1 = op1;
		operand2 = op2;
		if(op1.result instanceof TAInt && op2.result instanceof TAInt)
