...
public class TAXor extends TABinaryFormulae
{
	TAObject operand1;
	TAObject operand2;
	public void list()
	...
	public TAXor(TAUnaryFormulae op1, TAUnaryFormulae op2)
	{
		operand1 = op1;
		operand2 = op2;
	...
	public TAXor(TAUnaryFormulae op1, TABool op2)
	{
		operand1 = op1;
		operand2 = op2;
	...
	public TAXor(TABinaryFormulae op1,TAUnaryFormulae op2)
	{
		operand1 = op1;
		operand2 = op2;
		if(op1.result instanceof TABool && op2.result instanceof TABool)
	...
	public TAXor(TABinaryFormulae op1,TABool op2)
	{
		operand1 = op1;
		operand2 = op2;
		if(op1.result instanceof TABool && op2 instanceof TABool)
	...
	public TAXor(TABinaryFormulae op1,TABinaryFormulae op2)
	{
		operand1 = op1;
		operand2 = op2;
		if(op1.result instanceof TABool && op2.result instanceof TABool)
