...
public class TAOr extends TABinaryFormulae
{
	TAObject operand1;
	TAObject operand2;
	public void list()
	...
	public TAOr(TAUnaryFormulae op1, TAUnaryFormulae op2)
	{
		operand1 = op1;
		operand2 = op2;
	...
	public TAOr(TAUnaryFormulae op1, TABool op2)
	{
		operand1 = op1;
		operand2 = op2;
	...
	public TAOr(TABinaryFormulae op1,TABinaryFormulae op2)
	{
		operand1 = op1;
		operand2 = op2;
		if(op1.result instanceof TABool && op2.result instanceof TABool)
	...
	public TAOr(TABinaryFormulae op1,TABool op2)
	{
		operand1 = op1;
		operand2 = op2;
		if(op1.result instanceof TABool && op2 instanceof TABool)
	...
	public TAOr(TABinaryFormulae op1,TAUnaryFormulae op2)
	{
		operand1 = op1;
		operand2 = op2;
		if(op1.result instanceof TABool && op2.result instanceof TABool)
